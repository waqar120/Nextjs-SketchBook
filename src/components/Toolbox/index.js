...
import { changeColor, changeBrushSize } from "../slice/tollboxSlice";
...
const Tollbox = () => {
  ...
  const showStokeToolOption = activeMenuItem === MENU_ITEMS.PENCIL;
  const showEraserToolOption =
  ...
  return (
    <div className={styles.toolboxContainer}>
      ...
      {showEraserToolOption && (
        <div className={styles.toolItem}>
          <h4 className={styles.toolText}>Brush Color {activeMenuItem}</h4>
          <div className={styles.itemContainer}>
            <input
              type="range"
              min={0}
